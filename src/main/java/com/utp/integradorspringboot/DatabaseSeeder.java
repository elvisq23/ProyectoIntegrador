...
public class DatabaseSeeder {
    ...
    private void seedUsuariosYRoles() {
        if (usuarioRepository.count() == 0) {
            ...
            Usuario dueno = new Usuario("Ana", "Contreras", "111111", "900111111", "", "dueno@ejemplo.com", "$2a$12$gRpbwFfmJKV0z8e5rjHQ4uHfW4Fe84O.YpdvfmHhGFh1D7KVB7B5G", now, true, null);
            Usuario gerente = new Usuario("Luis", "Ramos", "222222", "900222222", "", "gerente@ejemplo.com", "$2a$12$WI2IewOnPU5TqLIPMFKAzepB7QptAbHrIbkEO6/fLOdJw57DIgRs2", now, true, null);
            Usuario asesor = new Usuario("María", "Del Pilar", "333333", "900333333", "", "asesor@ejemplo.com", "$2a$12$DtpUGSusnf3hMDEnEP7yK..Q5GRtAfmjgPAN92Zbhu1YrYvturQNq", now, true, null);
            Usuario mecanico = new Usuario("Pedro", "Pascal", "444444", "900444444", "", "mecanico@ejemplo.com", "$2a$12$KClwsXKwjyiN4.0/8XpmxOWhEj9yDZEO6QESxQMPhUzVv6oWTg1gu", now, true, null);
            Usuario almacen = new Usuario("Lucía", "Ramirez", "555555", "900555555", "", "almacen@ejemplo.com", "$2a$12$rbAUTOt95J2DBzKutSG10uVVehzl0JINYher.e0.gIslm7OV/yLj6", now, true, null);
            Usuario cajero = new Usuario("Jorge", "Pinto", "666666", "900666666", "", "cajero@ejemplo.com", "$2a$12$u3DXjW.qUL8qi3qpggaca.8KTlY70hxn8WMQyrmrrEfAFdPkoi21q", now, true, null);
            Usuario conductor = new Usuario("Carlos", "Lozano", "777777", "900777777", "", "conductor@ejemplo.com", "$2a$12$W.fxa/QqSoC0O9uSAR6ImO6X3c.cyVcJacw5OaIZOfXxYLrm2I.e6", now, true, sedeParaConductor);
